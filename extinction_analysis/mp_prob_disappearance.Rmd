...
sim.disapp.tab <- rbind(prob.disapp.tab(sim.otutab_33, subj.id = "SUBJ_33"),
                        prob.disapp.tab(sim.otutab_77, subj.id = "SUBJ_77"))

# sim.disapp.tab$avg.rel.abnd <- apply(sim.otutab.D, 1, mean)

head(sim.disapp.tab)

ggplot(sim.disapp.tab, aes(x=avg.asin, y=prob.disappear)) +
