...
avg.asin.D <- otu.avg.asin(otutab.D)
avg.asin.E <- otu.avg.asin(otutab.E)
avg.asin.F <- otu.avg.asin(otutab.F)
avg.asin.F4 <- otu.avg.asin(otutab.F4)
avg.asin.M3 <- otu.avg.asin(otutab.M3)
...
disapp.tab.ALL <- rbind(asin.disapp.tab(otutab.D, 'D'),
                        asin.disapp.tab(otutab.E, 'E'),
                        asin.disapp.tab(otutab.F, 'F'),
                        asin.disapp.tab(otutab.F4, 'F4'),
                        asin.disapp.tab(otutab.M3, 'M3'))

ggplot(disapp.tab.ALL, aes(x=prob.disappear, color=subj.id)) +
  geom_density(aes(fill = subj.id), alpha = 0.1) + 
  labs(title = "Distribution of disappearance probabilities",
