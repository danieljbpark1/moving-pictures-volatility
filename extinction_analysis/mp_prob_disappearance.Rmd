...
sim.disapp.tab <- prob.disapp.tab(otutab = sim.otutab.m3, subj.id = "M3")
sim.disapp.tab$avg.rel.abnd <- apply(sim.otutab.m3, 1, mean)

head(sim.disapp.tab)

ggplot(sim.disapp.tab, aes(x=avg.rel.abnd, y=prob.disappear)) +
  ...
  labs(title = "OTU Probabilities of Disappearance",
       ...
       color = "Subject ID",
       x = "average within-subject average abundance", 
...
disapp.tab.ALL <- prob.disapp.tab(otutab.m3, "M3")
disapp.tab.ALL$avg.rel.abnd <- apply(rel.otutab.m3, 1, mean)
