...
sim.reappeared.relabs.tab <- rbind(format_reappearance_data(otutab = sim.otutab.f4, 
                                                            otu.rarity = avg.asin.abnd(sim.otutab.f4), 
                                                            subj.id = "F4"),
                                   format_reappearance_data(otutab = sim.otutab.m3, 
...
#   filter(y > 0)
reappeared.relabs.tab <- rbind(format_reappearance_data(otutab = rel.otutab.f4, 
                                                        otu.rarity = avg.asin.abnd(rel.otutab.f4), 
                                                        subj.id = "F4"),
                               format_reappearance_data(otutab = rel.otutab.m3, 
