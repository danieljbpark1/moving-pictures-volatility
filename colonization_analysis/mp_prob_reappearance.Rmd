...
dr.D.reapp.tab <- format_reappearance_data(dr.D.otutab,
                                           dr.D.avg.asin,
                                           subjID = "D")
dr.E.reapp.tab <- format_reappearance_data(dr.E.otutab,
                                           dr.E.avg.asin,
                                           subjID = "E")
dr.F.reapp.tab <- format_reappearance_data(dr.F.otutab,
                                           dr.F.avg.asin, 
                                           subjID = "F")
mp.F4.reapp.tab <- format_reappearance_data(otu.counts.f4,
                                            mp.F4.avg.asin,
                                            subjID = "F4")
mp.M3.reapp.tab <- format_reappearance_data(otu.counts.m3,
                                            mp.M3.avg.asin,
                                            subjID = "M3")
