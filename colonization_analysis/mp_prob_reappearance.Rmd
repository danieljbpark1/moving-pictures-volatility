...
sim.reapp.tab <- rbind(prob.reapp.tab(otutab = sim.otutab.f4, subj.id = "F4"),
                       prob.reapp.tab(otutab = sim.otutab.m3, subj.id = "M3"))
...
reapp.plot <- ggplot(reapp.tab.ALL, aes(x = avg.asin, y = prob.reappear)) +
